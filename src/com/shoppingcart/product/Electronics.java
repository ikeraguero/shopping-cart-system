...
public class Electronics extends Product{
    ...
    public Electronics(String name, double basePrice, String isOnSale, int discountPercentage, String hasWarranty, int quantity) {
        super(name, basePrice, isOnSale, discountPercentage, hasWarranty, quantity, "electronics");
        this.calculatePrice();
    }

    public static Product createElectronic(String productName, double basePrice, String isOnSale, int discountPercentage, String hasWarranty, int quantity) {
